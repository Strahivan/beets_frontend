	...
	_detailsInit: function ()
	{
		...
		$( dt.table().body() )
			...
			.on( 'click.dtr', selector, function () {
                ...
                $('td #'+star).clone(true).appendTo('span .'+star);
			} );
	},
	...
	details: {
		...
		renderer: function ( api, rowIdx, columns ) {
			var data = $.map( columns, function ( col, i ) {
                var temp = col.data.split('"');
                if(temp[3] != undefined && temp[3].includes('star'))
                    star = temp[3];
				if(col.data === '<div class="rate" id="'+star+'"></div>')
					col.data = '<div class='+star +'></div>';
				return col.hidden ?
					'<li data-dtr-index="'+i+'">'+
